...
const CORE_TEAM = [
  ...
  },
  {
    ...
    bioZh: '王先生曾在网易、科大讯飞等多家大型科技公司担任项目管理专家。在网易期间主导多款互联网产品的全生命周期项目管理，积累了高并发消费级产品从立项到规模化上线的完整经验；在科大讯飞深耕 AI 技术产品落地，对超大型项目有丰富的管理经验。在复杂技术产品的规划、执行和跨部门协同方面积累了深厚的方法论与实战经验。',
    bioEn: 'Mr. Wang has served as a project management expert at major tech companies including NetEase and iFlytek. At NetEase he led full lifecycle project management for multiple consumer internet products, gaining end-to-end experience from ideation to scaled launch of high-concurrency products. At iFlytek he focused on AI product delivery. He brings deep expertise in planning, execution, and cross-departmental collaboration for complex technology products.',
    ...
    prevZh: '网易 / 科大讯飞 项目管理专家',
    prevEn: 'Project Management Expert at NetEase / iFlytek',
  },
  {
    id: 'longgang',
    avatar: '龙',
